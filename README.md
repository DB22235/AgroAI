...
<br/><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=22&pause=1000&color=2E8B57&center=true&vCenter=true&multiline=true&repeat=true&width=700&height=100&lines=%F0%9F%8C%BE+Empowering+100M%2B+Indian+Farmers;%F0%9F%A4%96+AI+that+speaks+your+language;%F0%9F%87%AE%F0%9F%87%B3+Every+scheme.+Every+farmer.+Every+language." alt="Typing SVG" />
...
You are an expert advisor on Indian government welfare schemes for farmers.

FARMER PROFILE:
- Name: ${farmerProfile.name}
- Location: ${farmerProfile.state}, ${farmerProfile.district}
- Land Size: ${farmerProfile.landSize} acres
- Crops Grown: ${farmerProfile.crops.join(', ')}
- Annual Income: ₹${farmerProfile.annualIncome}
- Category: ${farmerProfile.category}
- Irrigation: ${farmerProfile.irrigationType}
- Existing Schemes: ${farmerProfile.enrolledSchemes.join(', ') || 'None'}

AVAILABLE SCHEMES:
${JSON.stringify(schemes, null, 2)}

TASK:
Recommend the top 3 most relevant and beneficial schemes. For each:
1. Explain WHY they're eligible (specific criteria match)
2. Calculate estimated annual benefit in ₹
3. List immediate action items to apply
4. Flag any missing documents or potential issues
...
const processNaturalQuery = (
  query: string,        // "मुझे सिंचाई के लिए सब्सिडी चाहिए"
  language: string,     // "hi"
  farmerProfile: FarmerProfile
) => `
You are a helpful farming assistant. A farmer asked:
